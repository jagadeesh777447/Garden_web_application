...
components.swiper = {
	...
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
			let
				progress = new aProgressCircle({ node: node.querySelector( '.swiper-progress' ) }),
...
components.price = {
	selector: '.price',
	styles: './assets/components/price/price.css'
};
...
components.layer = {
	selector: '.layer',
	styles: './assets/components/layer/layer.css'
};
...
components.banner = {
	...
	styles: './assets/components/banner/banner.css'
};
...
components.videoPlay = {
	selector: 'video',
	styles: './assets/components/video-play/video-play.css',
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
...
components.section1 = {
	selector: '.layer-1',
	script: './assets/components/anime-js/anime.min.js',
	init: function ( nodes ) {
		nodes.forEach( function ( node ) {
			let
				duration = 1000,
		...
		onError: function ( error ) {
			setTimeout( () => {
				if ( detectIE() < 12 ) {
					...
					script.src = './assets/components/base/support.js';
